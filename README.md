...
It carries start/stop/status capture requests and typed replies. Runtime audio
capture, durable disk write, transcription, clipboard delivery, sockets, and
state live in `listener`.
